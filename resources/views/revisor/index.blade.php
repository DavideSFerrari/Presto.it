    ...
    <div class="container">
        <div class="row">
            ...
            <div class=" m-3 product-card rounded-3 card-custom shadow" style="width: 18rem;">
                <img src="https://picsum.photos/id/27/1200/400" class="card-img-top my-3 rounded-3" alt="..." style="height: 7rem;">
                <div class="product-details">
                    <h5 class="card-title text-break">{{$announcement_to_check->title}}</h5>
                    <p class="card-text py-2 text-break text-lowercase">{{$announcement_to_check->description}}</p>
                    <hr class="text-dark">
